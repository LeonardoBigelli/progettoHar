...
class SensorReaderHelper(
    ...
    private val mData: SharedData = SharedData(samplingWindowSize)
    private var mListener: SensorProducer? = null
    private val mConsumerRn: SensorConsumer = SensorConsumer(mData, handler)
    ...
    fun start() {
        ...
        mConsumerThread = Thread(mConsumerRn as Runnable, consumerThreadName)
